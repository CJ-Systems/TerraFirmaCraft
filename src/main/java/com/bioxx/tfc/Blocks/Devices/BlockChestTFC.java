...
public class BlockChestTFC extends BlockTerraContainer {
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase player, ItemStack itemStack) {
        ...
        ForgeDirection adjDirection = getAdjacentChestDirection(world, x, y, z, itemStack.getMetadata());
        ...
        if (itemStack.hasDisplayName())
            ((TEChest) world.getTileEntity(x, y, z)).setCustomName(itemStack.getDisplayName());
    }
