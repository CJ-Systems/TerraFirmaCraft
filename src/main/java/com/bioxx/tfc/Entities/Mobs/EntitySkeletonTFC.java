...
public class EntitySkeletonTFC extends EntityMob implements IRangedAttackMob, ICausesDamage, IInnateArmor {
     ...
     */
    @Override
    protected void playStepSound/* playStepSound */(int par1, int par2, int par3, Block par4) {
    ...
    public IEntityLivingData onSpawnWithEgg(IEntityLivingData par1EntityLivingData) {
        ...
        this.setCanPickUpLoot(
            this.rand.nextFloat() < 0.55F * this.worldObj
                .getTensionFactorForBlock/* getLocationTensionFactor */(this.posX, this.posY, this.posZ));
