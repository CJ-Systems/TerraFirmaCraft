    ...
    public void render(RenderGameOverlayEvent.Pre event) {
        ...
        if (mc.playerController.gameIsSurvivalOrAdventure()) {
            ...
            mc.fontRendererObj.drawString(
                healthString,
                mid - 45 - (mc.fontRendererObj.getStringWidth(healthString) / 2),
                healthRowHeight + 2,
                Color.white.getRGB());
            if (player.getEntityAttribute(SharedMonsterAttributes.movementSpeed)
                ...
                mc.fontRendererObj.drawString(
                    ...
                    mid - (mc.fontRendererObj.getStringWidth(TFC_Core.translate("gui.overburdened")) / 2),
                    healthRowHeight - 20,
                    Color.red.getRGB());
            ...
            if (player.ridingEntity instanceof EntityLivingBase) {
                ...
                mc.fontRendererObj.drawString(
                    mountHealthString,
                    mid + 47 - (mc.fontRendererObj.getStringWidth(mountHealthString) / 2),
                    armorRowHeight + 2,
                    Color.white.getRGB());
        ...
        if (recordTimer > 0) {
            ...
            if (opacity > 0) {
                try {
                    ...
                    mc.fontRendererObj.drawString(
                        recordPlaying,
                        -mc.fontRendererObj.getStringWidth(recordPlaying) / 2,
                        -12,
                        0xFFFFFF | (opacity << 24));
