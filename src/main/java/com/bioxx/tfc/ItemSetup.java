...
public class ItemSetup extends TFCItems {
    ...
    public static void setup() {
        ...
        igInShovel = new ItemCustomShovel(igInToolMaterial).setUnlocalizedName("IgIn Stone Shovel")
            .setMaxDurability(igInStoneUses);
        ...
        igExShovel = new ItemCustomShovel(igExToolMaterial).setUnlocalizedName("IgEx Stone Shovel")
            .setMaxDurability(igExStoneUses);
        ...
        bismuthBronzePick = new ItemCustomPickaxe(bismuthBronzeToolMaterial).setUnlocalizedName("Bismuth Bronze Pick")
            .setMaxDurability(bismuthBronzeUses);
        ...
        blackBronzePick = new ItemCustomPickaxe(blackBronzeToolMaterial).setUnlocalizedName("Black Bronze Pick")
            .setMaxDurability(blackBronzeUses);
        ...
        blackSteelPick = new ItemCustomPickaxe(blackSteelToolMaterial).setUnlocalizedName("Black Steel Pick")
            .setMaxDurability(blackSteelUses);
        ...
        blueSteelPick = new ItemCustomPickaxe(blueSteelToolMaterial).setUnlocalizedName("Blue Steel Pick")
            .setMaxDurability(blueSteelUses);
        ...
        wroughtIronPick = new ItemCustomPickaxe(ironToolMaterial).setUnlocalizedName("Wrought Iron Pick")
            .setMaxDurability(wroughtIronUses);
        ...
        quern = ((ItemTerra) new ItemTerra().setUnlocalizedName("Quern")
            .setMaxDurability(250)).setSize(EnumSize.MEDIUM)
