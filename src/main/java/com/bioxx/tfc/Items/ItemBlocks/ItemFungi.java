        ...
        if (movingobjectposition == null) {
            ...
            if (movingobjectposition.typeOfHit == MovingObjectType.BLOCK) {
                ...
                if (TFCBlocks.fungi.canBlockStay(par2World, i, j + 1, k) && par2World.isAirBlock(i, j + 1, k)) {
                    par2World.setBlock(i, j + 1, k, TFCBlocks.fungi, par1ItemStack.getMetadata(), 0x3);
                    par2World.playSoundEffect(
                        i + 0.5F,
                        j + 0.5F,
                        k + 0.5F,
                        TFCBlocks.fungi.stepSound.getPlaceSound(),
                        (TFCBlocks.fungi.stepSound.getVolume() + 1.0F) / 2.0F,
                        TFCBlocks.fungi.stepSound.getFrequency() * 0.8F);
