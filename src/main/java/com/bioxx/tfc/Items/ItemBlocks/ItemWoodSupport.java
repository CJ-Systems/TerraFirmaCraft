    ...
    public boolean onItemUse(ItemStack itemstack, EntityPlayer player, World world, int x, int y, int z, int side,
        ...
        if (y < 250 && y > 0 && side == 1 && isValidUnder(world, x, y, z, side)) {
            if (!player.isSneaking() && world.isAirBlock(x, y + 1, z)
                ...
                placeBlockAt(getBlock(), itemstack, player, world, x, y + 1, z, itemstack.getMetadata(), 2);
                placeBlockAt(getBlock(), itemstack, player, world, x, y + 2, z, itemstack.getMetadata(), 2);
                placeBlockAt(getBlock(), itemstack, player, world, x, y + 3, z, itemstack.getMetadata(), 2);
                itemstack.stackSize -= 3;
                return true;
            } else {
                placeBlockAt(getBlock(), itemstack, player, world, x, y + 1, z, itemstack.getMetadata(), 3);
                itemstack.stackSize--;
                return true;
            }
            ...
            if (itemstack.stackSize >= dist - 1) for (int j = dist - 1; j >= 1 && shouldGen; j--) {
                if (world.getBlock(x, y - j, z)
                    ...
                    placeBlockAt(getBlock(), itemstack, player, world, x, y - j, z, itemstack.getMetadata(), 3);
                    --itemstack.stackSize;
