...
public class ItemLogs extends ItemTerra {
    ...
    private boolean createPile(ItemStack itemstack, EntityPlayer entityplayer, World world, int x, int y, int z,
        ...
        if (te != null) {
            te.storage[0] = new ItemStack(this, 1, itemstack.getMetadata());
            if (entityplayer.capabilities.isCreativeMode) {
                te.storage[0] = new ItemStack(this, 4, itemstack.getMetadata());
                te.storage[1] = new ItemStack(this, 4, itemstack.getMetadata());
                te.storage[2] = new ItemStack(this, 4, itemstack.getMetadata());
                te.storage[3] = new ItemStack(this, 4, itemstack.getMetadata());
            }
        }
    ...
    private void playSound(World world, int x, int y, int z) {
        world.playSoundEffect(
            ...
            y + 0.5,
            z + 0.5,
            TFCBlocks.logNatural.stepSound.getPlaceSound(),
            (TFCBlocks.logNatural.stepSound.getVolume() + 1.0F) / 2.0F,
            TFCBlocks.logNatural.stepSound.getFrequency() * 0.8F);
    }
}
