            ...
            if (side == 1) {
                ...
                if (world.getTileEntity(x, y + offset, z) != null
                    ...
                    if (hitX < 0.5 && hitZ < 0.5) {
                        if (te.canAddItem(0)) {
                            te.inventory[0] = new ItemStack(this, 1, itemstack.getMetadata());
                        ...
                        if (te.canAddItem(1)) {
                            te.inventory[1] = new ItemStack(this, 1, itemstack.getMetadata());
                        ...
                        if (te.canAddItem(2)) {
                            te.inventory[2] = new ItemStack(this, 1, itemstack.getMetadata());
                            te.inventory[2].stackTagCompound = itemstack.stackTagCompound;
                            itemstack.stackSize--;
                            world.markBlockForUpdate(x, y + offset, z);
                        }
                    } else if (hitX > 0.5 && hitZ > 0.5) if (te.canAddItem(3)) {
                        te.inventory[3] = new ItemStack(this, 1, itemstack.getMetadata());
