...
public class ItemJavelin extends ItemTerraTool implements ICausesDamage, IProjectile, IQuiverAmmo {
    ...
    public ItemJavelin(ToolMaterial par2EnumToolMaterial, float damage) {
        ...
        this.setMaxDurability(par2EnumToolMaterial.getMaxUses() / 2);
    ...
    public void onPlayerStoppedUsing(ItemStack itemstack, World world, EntityPlayer player, int itemInUseCount) {
        if (!world.isRemote) {
            ...
            javelin.setDamageTaken((short) itemstack.getMetadata());
    ...
    public Multimap getAttributeModifiers(ItemStack stack) {
        ...
        multimap.put(
            ...
            new AttributeModifier(itemModifierUUID, "Weapon modifier", getWeaponDamage(stack), 0));
        return multimap;
    }
    ...
    public int getMaxDamage(ItemStack is) {
        return (int) Math.floor(getMaxDurability() + (getMaxDurability() * AnvilManager.getDurabilityBuff(is)));
    }
