...
public class ItemProPick extends ItemTerra {
    ...
    public boolean onItemUse(ItemStack itemStack, EntityPlayer player, World world, int x, int y, int z, int side,
        ...
        if (!world.isRemote) {
            ...
            if (itemStack.getMetadata() >= itemStack.getMaxDurability()) player.destroyCurrentEquippedItem();
        }
    ...
    public int getMaxDamage(ItemStack stack) {
        return (int) (getMaxDurability() + (getMaxDurability() * AnvilManager.getDurabilityBuff(stack)));
    }
