...
public class TESRQuern extends TESRBase implements ISimpleBlockRenderingHandler {
    ...
    public void renderTileEntityAt(TileEntity te, double xDis, double yDis, double zDis, float f) {
        ...
        GL11.glPushMatrix();
        {
            ...
            if (teq.hasQuern) {
                 ...
                 */
                this.renderRoundTop(tess, teq.rotatetimer, teq.getWorld().rand, 0.8, true); // Renders a round Quern top
                                                                                            // stone
                // this.renderSquareTop(tess); // Renders the top Quern box

                renderWoodHandle(tess, teq.rotatetimer, teq.getWorld().rand, 0.8); // Renders the wooden handle
    ...
    private void renderItem(ItemStack is) {
        EntityItem customitem = new EntityItem(field_147501_a.worldObj);
