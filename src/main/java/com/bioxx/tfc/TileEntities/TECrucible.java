    ...
    public void updateEntity() {
        if (!worldObj.isRemote) {
            ...
            if (stackToSmelt != null) {
                ...
                int newDamage = stackToSmelt.getMetadata() + 1;
                int maxDamage = stackToSmelt.getMaxDurability() - 1; // Subtract one so we never have an unshaped metal
                                                                     // with 0/100 units
                    ...
                    if (inputTick > 10) {
                        ...
                        if (currentAlloy != null && currentAlloy.outputType != null
                            ...
                            if (newDamage >= maxDamage) {
                                ...
                                stackToSmelt.setMetadata(newDamage);
                            }
                        } else {
                            this.addMetal(inputMetal, (short) 1);
                            if (newDamage >= maxDamage) {
            ...
            if (currentAlloy != null && storage[1] != null
                ...
                if (storage[1].getItem() == TFCItems.ceramicMold) {
                    ...
                    drainOutput(1.0f);
                    updateGui((byte) 1);
                } else if (storage[1].getItem() == currentAlloy.outputType.meltedItem && storage[1].getMetadata() > 0) {
                    storage[1].setMetadata(storage[1].getMetadata() - 1);
