...
public class TEHopper extends NetworkTileEntity implements IHopper {
    ...
    public String getInventoryName() {
        return this.isCustomInventoryName() ? this.customName : "container.hopper";
    }
    ...
    public static IInventory getInputInventory(IHopper hopper) {
        return searchForOutputInventory(hopper.getWorld(), hopper.getXPos(), hopper.getYPos() + 1.0D, hopper.getZPos());
    }
     ...
     * {
     * return stack1.getItem() != stack2.getItem() ? false : stack1.getMetadata() != stack2.getMetadata() ? false
